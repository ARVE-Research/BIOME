...
! This is newspline, a fast, mean-preserving spline for interval data
! Jed O. Kaplan, Leo Lai, & Leo Lai. (2021). ARVE-Research/newspline: First official release (v3.0.0). 
! Zenodo. https://doi.org/10.5281/zenodo.5783076
!
! see also:
